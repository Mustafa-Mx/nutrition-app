...
export default function Err404() {
  ...
  return (
    <div className="h-screen w-screen bg-gray-900 flex justify-center items-center">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-[#f58820]">
        <div className="max-w-md">
          ...
          <button onClick={()=>navigate('/')} className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border hover:border-[#f58820] rounded-lg focus:outline-none focus:shadow-outline-orange bg-[#f58820] active:bg-[#f58820] hover:bg-[#f58820]">
            Back to homepage
          </button>
          <button onClick={()=>window.location.reload(false)} className="ml-2 px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border hover:border-[#f58820] rounded-lg focus:outline-none focus:shadow-outline-orange bg-orange-900 active:bg-orange-900 hover:bg-orange-800">
            Try Again?
          </button>
        </div>
